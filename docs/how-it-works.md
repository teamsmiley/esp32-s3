...
```
  ...
  ┃ 6   ┃
  ┃ in  ┃
  ┃  ●  ┃ ← sensor (midpoint, reads bottom - 0.1524 m)
  ┃ 6   ┃
  ┃ in  ┃
   ━━━━━ ← bottom (= sensor + 0.1524 m)
```
